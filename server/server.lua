...
RegisterCommand('priolist', function(source, args, rawCommand)
    ...
    -- Create a string to store the list of player names
    local playerList = ""
    ...
    if prioType == "county" then
        ...
        if next(countyPrioPlayers) == nil then
            ...
            -- Loop through the players in county priority and add their names to the list
            for player, _ in pairs(countyPrioPlayers) do
                playerList = playerList .. GetPlayerName(player) .. "\n"
            end
        end
    elseif prioType == "city" then
        ...
        if next(cityPrioPlayers) == nil then
            ...
            -- Loop through the players in city priority and add their names to the list
        ...
        TriggerClientEvent('chat:addMessage', source, {
            color = {255, 0, 0},
            args = {"[SimplePrio]", "Invalid priority type. Use 'county' or 'city'."}
        })
        return
    end
...
RegisterCommand('priohelp', function(source, args, rawCommand)
    ...
    if args[1] == Config.Priorities.County_Priority.Commands.mainCommand then
        TriggerClientEvent('chat:addMessage', source, {
            ...
            args = {
                "~w~~w~[~b~SimplePrio~w~]  ",
                "Commands for County Prio: \n /priority " .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.StartPrio .. "\n /priority " .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.EndPrio .. "\n /priority " .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.JoinPrio .. "\n /priority " .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.LeavePrio .. "\n /priority " .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.PrioCooldown .. "\n /priority " .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.PrioReset .. "\n /priority " .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.PrioOnHold
            }
        })
    elseif args[1] == Config.Priorities.City_Priority.Commands.mainCommand then
        TriggerClientEvent('chat:addMessage', source, {
            ...
            args = {
                "~w~~w~[~b~SimplePrio~w~]  ",
                "Commands for City Prio: \n /priority " .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.StartPrio .. "\n /priority " .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.EndPrio .. "\n /priority " .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.JoinPrio .. "\n /priority " .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.LeavePrio .. "\n /priority " .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.PrioCooldown .. "\n /priority " .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.PrioReset .. "\n /priority " .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.PrioOnHold
            }
        })
    else
        TriggerClientEvent('chat:addMessage', source, {
            color = {255, 0, 0},
            args = {"~w~[~b~SimplePrio~w~] ", "Invalid Priority System, Usage: /priohelp <" .. Config.Priorities.County_Priority.Commands.mainCommand .. "/" .. Config.Priorities.City_Priority.Commands.mainCommand .. ">"}
        })
    end
end)
...
RegisterCommand('priority', function(source, args, rawCommand)
    ...
    if args == nil or #args < 2 then
        ...
        TriggerClientEvent('chat:addMessage', source, {
            color = {255, 0, 0},
            args = {"~w~[~b~SimplePrio~w~] ", "Usage: /priority <type> <action>"}
        })
        return
    end
    ...
    local type = args[1]
    local action = args[2]
    local defaultCountyTimer = Config.Priorities.County_Priority.TextSettings.CooldownSettings.CooldownTimer
    local defaultCityTimer = Config.Priorities.City_Priority.TextSettings.CooldownSettings.CooldownTimer

    -- Check if the type and action are not nil
    if type == nil or action == nil then
        TriggerClientEvent('chat:addMessage', source, {
            color = {255, 0, 0},
            args = {"~w~[~b~SimplePrio~w~] ", "Invalid arguments provided. Usage: /priority <type> <action>"}
        })
        return
    end
    ...
    if type == Config.Priorities.County_Priority.Commands.mainCommand then
        ...
        elseif action == Config.Priorities.County_Priority.Commands.PrioOnHold then
            ...
            TriggerClientEvent('chat:addMessage', source, {
                color = {255, 0, 0},
                args = {"~w~[~b~SimplePrio~w~] ", "Invalid action for countywide priority. Use 'start', 'end', 'cooldown', 'hold', or 'reset'."}
            })
            return
        end
    elseif type == Config.Priorities.City_Priority.Commands.mainCommand then
        ...
        elseif action == Config.Priorities.City_Priority.Commands.PrioOnHold then
            ...
            TriggerClientEvent('chat:addMessage', source, {
                color = {255, 0, 0},
                args = {"~w~[~b~SimplePrio~w~] ", "Invalid action for citywide priority. Use 'start', 'end', 'cooldown', 'hold', or 'reset'."}
            })
            return
        end
    else
        ...
        TriggerClientEvent('chat:addMessage', source, {
            color = {255, 0, 0},
            args = {"~w~[~b~SimplePrio~w~]  ", 'Invalid priority type. Use "' .. Config.Priorities.City_Priority.Commands.mainCommand .. '" or "' .. Config.Priorities.County_Priority.Commands.mainCommand .. '".'}
        })
        return
    end
end, false)
...
function StartCountyPriority(source)
    ...
    if countyPrioCooldown then
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ERROR: ~y~You cannot start a priority due to cooldown!"}
        })
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *Countywide Priority Cooldown is currently active!*\n **→ Priority System (City / County):** *County*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.StartPrio .. '*.')
        return
    elseif countyPrioHold then
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ERROR: ~y~You cannot start a priority due to it being on hold!"}
        })
    ...
    elseif countyPrioActive then
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~] : ", "~r~ERROR: ~y~You cannot start a priority as one is already started!"}
        })
    ...
    elseif peacetimeon then
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~] : ", "~r~ERROR: ~y~You cannot start a priority whilst peacetime is on!"}
        })
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *There is currently already a priority active within county limits!*\n **→ Priority System (City / County):** *County*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.StartPrio .. '*.')
        ...
        TriggerClientEvent("chat:addMessage", -1, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~y~ALERT: ~r~A countywide priority has been ~g~started ~r~by ~o~" .. GetPlayerName(player) .. "~r~!"}
        })
        ...
        countyPrio = Config.Priorities.County_Priority.TextSettings.StatusMessages.StatusActive .. '~c~ (~w~' .. numPlayersInCountyPrio .. '/4~c~ in priority) (~w~/priolist~c~)'
        TriggerClientEvent('SimplePrio:County:ReturnPrio', -1, countyPrio)
        SimplePrio_Success('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *True* \n** → Details:** *Priority Status in the county has been started*\n **→ Priority System (City / County):** *County*\n \n*→' .. numPlayersInCountyPrio .. '/4* **Players in County Priority!**\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.StartPrio .. '*.')
    end
end
...
function StartCityPriority(source)
    ...
    if cityPrioCooldown then
        ...
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *Citywide Priority Cooldown is currently active!*\n **→ Priority System (City / County):** *City*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.PrioCooldown .. '*.')
        return
    elseif cityPrioHold then
        ...
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *The citywide priority system is currently on hold!*\n **→ Priority System (City / County):** *City*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.PrioOnHold .. '*.')
    elseif cityPrioActive then
        ...
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *There is currently already a priority active within city limits!*\n **→ Priority System (City / County):** *City*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.StartPrio .. '*.')
        return
    else
        cityPrioActive = true
        TriggerClientEvent("chat:addMessage", -1, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~y~ALERT: ~r~A citywide priority has been ~g~started ~r~by ~o~" .. GetPlayerName(player) .. "~r~!"}
        })
        cityPrioPlayers[player] = GetPlayerName(player) .. " #" .. player
        -- Update the countyPrio variable whenever the count changes
        UpdateNumPlayersInCityPrio(numPlayersInCityPrio + 1)
        cityPrio = Config.Priorities.City_Priority.TextSettings.StatusMessages.StatusActive .. '~c~ (~w~' .. numPlayersInCityPrio .. '/4~c~ in priority) (~w~/priolist~c~)'
        TriggerClientEvent('SimplePrio:City:ReturnPrio', -1, cityPrio)
        SimplePrio_Success('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *True* \n** → Details:** *Priority Status in the city has been started*\n **→ Priority System (City / County):** *City*\n \n*→' .. numPlayersInCityPrio .. '/4* **Players in City Priority!**\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.StartPrio .. '*.')
    end
end
...
function EndCountyPriority(source)
    if not countyPrioActive then
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ERROR: ~y~There is no priority that needs to be ended!"}
        })
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *There currently is no priority within the county that needs to be ended!*\n **→ Priority System (City / County):** *County*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.EndPrio .. '*.')
        return
    end
    if countyPrioPlayers[player] then
        TriggerClientEvent("chat:addMessage", -1, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", '~b~' .. GetPlayerName(player) .. ' ~r~has ended the priority in the county! Cooldown has been started!'}
        })
        ...
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~y~ALERT: ~r~You cannot end this priority as you are not a part of the priority!"}
        })
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *There currently is no priority within the county that needs to be ended!*\n **→ Priority System (City / County):** *County*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.EndPrio .. '*.')
    end
...
function EndCityPriority(source)
    if not cityPrioActive then
        ...
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *There currently is no priority within the city that needs to be ended!*\n **→ Priority System (City / County):** *City*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.EndPrio .. '*.')
        return
    end
    if cityPrioPlayers[player] then
        TriggerClientEvent("chat:addMessage", -1, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", '~b~' .. GetPlayerName(player) .. ' ~r~has ended the priority in the city! Cooldown has been started!'}
        })
        SimplePrio_Success('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *True* \n** → Details:** *Priority has been ended and put into cooldown!*\n **→ Priority System (City / County):** *City*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.EndPrio .. '*.')
        cityPrioPlayers = {}
...
function StartCountyCooldown(player, time)
    ...
    if countyPrioCooldown then
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~y~There is already a county cooldown active! Please wait for the current cooldown to end before starting another cooldown!"}
        })
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. playerName .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *There is currently already a countywide priority cooldown in effect!*\n **→ Priority System (City / County):** *County*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.PrioCooldown .. '*.')
        return
    else
        if IsPlayerAceAllowed(player, Config.Permissions.CooldownAcePermission) then 
            if time > 1 then
                TriggerClientEvent("chat:addMessage", -1, {
                    color = {255, 0, 0},
                    multiline = true,
                    args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~y~A countywide priority cooldown has started by ~b~" .. playerName .. "~y~ for ~r~" .. time .. ' minutes!'}
                })
            else
                TriggerClientEvent("chat:addMessage", -1, {
                    color = {255, 0, 0},
                    multiline = true,
                    args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~y~A countywide priority cooldown has started by ~b~" .. playerName .. "~y~ for ~r~" .. time .. ' minute!'}
                })
            end
            countyPrioPlayers = {}
            numPlayersInCountyPrio = 0
            if time > 1 then 
                SimplePrio_Success('SimplePrio  \n', '**→ ' .. playerName .. ' used SimplePrio!\n ** **→ Successful: ** *True* \n** → Details:** *Countywide Priority has been started!*\n **→ Priority System (City / County):** *County*\n**→ Time Set:** *' .. time .. ' minutes*\n  \n**→ Time command was executed:** *' ..
                timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.PrioCooldown .. '*.')
            else
                SimplePrio_Success('SimplePrio  \n', '**→ ' .. playerName .. ' used SimplePrio!\n ** **→ Successful: ** *True* \n** → Details:** *Countywide Priority has been started!*\n **→ Priority System (City / County):** *County*\n**→ Time Set:** *' .. time .. ' minute*\n  \n**→ Time command was executed:** *' ..
                timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.PrioCooldown .. '*.')
            end
            ...
            TriggerClientEvent("chat:addMessage", player, {
                color = {255, 0, 0},
                multiline = true,
                args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ERROR: ~y~You do not have permissions to use this command!"}
            })
...
function StartCityCooldown(player, time)
    ...
    if cityPrioCooldown then
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~y~There is already a city cooldown active! Please wait for the current cooldown to end before starting another cooldown!"}
        })
        ...
        if IsPlayerAceAllowed(player, Config.Permissions.CooldownAcePermission) then 
            if time > 1 then
                TriggerClientEvent("chat:addMessage", -1, {
                    color = {255, 0, 0},
                    multiline = true,
                    args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~y~A citywide priority cooldown has started by ~b~" .. playerName .. "~y~ for ~r~" .. time .. ' minutes!'}
                })
            else
                TriggerClientEvent("chat:addMessage", -1, {
                    color = {255, 0, 0},
                    multiline = true,
                    args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~y~A citywide priority cooldown has started by ~b~" .. playerName .. "~y~ for ~r~" .. time .. ' minute!'}
                })
            end
            if time > 1 then 
                SimplePrio_Success('SimplePrio  \n', '**→ ' .. playerName .. ' used SimplePrio!\n ** **→ Successful: ** *True* \n** → Details:** *Citywide Priority has been started!*\n **→ Priority System (City / County):** *City*\n**→ Time Set:** *' .. time .. ' minutes*\n  \n**→ Time command was executed:** *' ..
                timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.PrioCooldown .. '*.')
            else
                SimplePrio_Success('SimplePrio  \n', '**→ ' .. playerName .. ' used SimplePrio!\n ** **→ Successful: ** *True* \n** → Details:** *Citywide Priority has been started!*\n **→ Priority System (City / County):** *City*\n**→ Time Set:** *' .. time .. ' minute*\n  \n**→ Time command was executed:** *' ..
                timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.PrioCooldown .. '*.')
...
function JoinCountyPriority(player)
    if not countyPrioActive then
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ERROR: ~y~There is not an active priority in the county that you can join!"}
        })
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *This user tried to join a priority that doesn\'t exist.*\n **→ Priority System (City / County):** *County*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.JoinPrio .. '*.')
        return
    end
    ...
    if countyPrioPlayers[player] then
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ERROR: ~y~You are already apart of this priority!"}
        })
    ...
    if numPlayersInCountyPrio == 4 then 
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ERROR: ~y~Priority is full! Please wait for a slot to open!"}
        })
        ...
        TriggerClientEvent("chat:addMessage", -1, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~y~ALERT: ~r~" .. GetPlayerName(player) .. "has ~g~joined~r~ the county priority!"}
        })
        countyPrioPlayers[player] = GetPlayerName(player) .. ' #' .. player
        UpdateNumPlayersInCountyPrio(numPlayersInCountyPrio + 1)
        countyPrio = Config.Priorities.County_Priority.TextSettings.StatusMessages.StatusActive .. '~c~ (~w~' .. numPlayersInCountyPrio .. '/4~c~ in priority) (~w~/priolist~c~)'
...
function JoinCityPriority(player)
    if not cityPrioActive then
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ERROR: ~y~There is not an active priority in the city that you can join!"}
        })
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *This user tried to join a priority that doesn\'t exist.*\n **→ Priority System (City / County):** *City*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.JoinPrio .. '*.')
        return
    end
    ...
    if numPlayersInCityPrio == 4 then 
        ...
        TriggerClientEvent("chat:addMessage", -1, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~y~ALERT: ~r~" .. GetPlayerName(player) .. "has ~g~joined~r~ the city priority!"}
        })
        cityPrioPlayers[player] = GetPlayerName(player) .. ' #' .. player
        UpdateNumPlayersInCityPrio(numPlayersInCityPrio + 1)
        cityPrio = Config.Priorities.City_Priority.TextSettings.StatusMessages.StatusActive .. '~c~ (~w~' .. numPlayersInCityPrio .. '/4~c~ in priority) (~w~/priolist~c~)'
...
function LeaveCountyPriority(player)
    if not countyPrioActive then
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ERROR: ~y~There is not an active priority you can leave!"}
        })
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *There wasn\'t any active priority that could be left.*\n **→ Priority System (City / County):** *County*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.LeavePrio .. '*.')
        return
    end
    ...
    if tableCount(countyPrioPlayers) == 1 and countyPrioPlayers[player] == GetPlayerName(player) .. ' #' .. player then
        TriggerClientEvent("chat:addMessage", -1, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~y~All players have left the active priority! Countywide Cooldown started automatically from ~b~SimplePrio~y~!"}
        })
        countyPrioPlayers = {}
        numPlayersInCountyPrio = 0
        countyCooldown(Config.Priorities.County_Priority.TextSettings.CooldownSettings.CooldownTimer)
        ...
        TriggerClientEvent("chat:addMessage", -1, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~y~ALERT: ~r~" .. GetPlayerName(player) .. " has ~g~left~r~ the county priority!"}
        })
...
function LeaveCityPriority(player)
    if not cityPrioActive then
        ...
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *There wasn\'t any active priority that could be left.*\n **→ Priority System (City / County):** *City*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.LeavePrio .. '*.')
        return
    end
    ...
    if tableCount(cityPrioPlayers) == 1 and cityPrioPlayers[player] == GetPlayerName(player) .. ' #' .. player then
        TriggerClientEvent("chat:addMessage", -1, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~y~All players have left the active priority! Citywide Cooldown started automatically from ~b~SimplePrio~y~!"}
        })
        cityPrioPlayers = {}
        numPlayersInCityPrio = 0
        cityCooldown(Config.Priorities.City_Priority.TextSettings.CooldownSettings.CooldownTimer)
        ...
        TriggerClientEvent("chat:addMessage", -1, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~y~ALERT: ~r~" .. GetPlayerName(player) .. " has ~g~left~r~ the city priority!"}
        })
...
function ResetCountyPriority(player)
    local playerName = GetPlayerName(player)
    if IsPlayerAceAllowed(player, Config.Permissions.ResetAcePermissions) then 
        if countyPrioActive then
            ...
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.PrioReset .. '*.')
        elseif countyPrioCooldown then
            TriggerClientEvent("chat:addMessage", player, {
                color = {255, 0, 0},
                multiline = true,
                args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~b~ You cannot reset the system as cooldown is ~g~enabled~b~! Please wait!"}
            })
        ...
        elseif countyPrioHold then
            ...
            TriggerClientEvent("chat:addMessage", -1, {
                color = {255, 0, 0},
                multiline = true,
                args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~b~" .. playerName .. ' ~y~has reset the countywide priority system!'}
            })
            SimplePrio_Success('SimplePrio  \n', '**→ ' .. playerName .. ' used SimplePrio!\n ** **→ Successful: ** *True* \n** → Details:** *This user has reset the countywide priority*\n **→ Priority System (City / County):** *County*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.PrioReset .. '*.')
            TriggerClientEvent('SimplePrio:County:ReturnPrio', -1, countyPrio) 
        ...
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ERROR: ~y~You lack the permissions requried to run this command!"}
        })
...
function ResetCityPriority(player)
    if IsPlayerAceAllowed(player, Config.Permissions.ResetAcePermissions) then 
        if cityPrioActive then
            ...
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.PrioReset .. '*.')
        ...
        elseif cityPrioHold then
            ...
            TriggerClientEvent("chat:addMessage", -1, {
                color = {255, 0, 0},
                multiline = true,
                args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~b~" .. GetPlayerName(player) .. ' ~y~has reset the citywide priority system!'}
            })
            SimplePrio_Success('SimplePrio  \n', '**→ ' .. GetPlayerName(player) .. ' used SimplePrio!\n ** **→ Successful: ** *True* \n** → Details:** *This user has reset the citywide priority*\n **→ Priority System (City / County):** *City*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.PrioReset .. '*.')
            TriggerClientEvent('SimplePrio:City:ReturnPrio', -1, cityPrio) 
    ...
    if IsPlayerAceAllowed(player, Config.Permissions.OnHoldAcePermission) then
        if countyPrioHold == true then
            ...
            TriggerClientEvent("chat:addMessage", -1, {
                color = {255, 0, 0},
                multiline = true,
                args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~b~" .. GetPlayerName(player) .. ' ~y~has ~r~disabled~y~ county priorities being on hold!'}
            })
            SimplePrio_Success('SimplePrio  \n', '**→ ' .. GetPlayerName(source) .. ' used SimplePrio!\n ** **→ Successful: ** *True* \n** → Details:** *Countywide Priorities have been disabled!*\n **→ Priority System (City / County):** *County*\n **→ Hold Status:** *Disabled*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.PrioOnHold .. '*.')
        else
            countyPrioHold = true
            ...
            TriggerClientEvent("chat:addMessage", -1, {
                color = {255, 0, 0},
                multiline = true,
                args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~b~" .. GetPlayerName(player) .. ' ~y~has ~g~enabled~y~ county priorities being on hold!'}
            })
        ...
        TriggerClientEvent("chat:addMessage", player, {
            color = {255, 0, 0},
            multiline = true,
            args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ERROR: ~y~You lack the permissions required to run this command!"}
        })
        SimplePrio_Fail('SimplePrio  \n', '**→ ' .. GetPlayerName(source) .. ' used SimplePrio!\n ** **→ Successful: ** *False* \n** → Details:** *This user lacks permissions required to use this command!*\n **→ Priority System (City / County):** *County*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.County_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.County_Priority.Commands.PrioOnHold .. '*.')
    end
    ...
    if IsPlayerAceAllowed(player, Config.Permissions.OnHoldAcePermission) then
        if cityPrioHold == true then
            ...
            TriggerClientEvent("chat:addMessage", -1, {
                color = {255, 0, 0},
                multiline = true,
                args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~b~" .. GetPlayerName(player) .. ' ~y~has ~r~disabled~y~ city priorities being on hold!'}
            })
            ...
            TriggerClientEvent("chat:addMessage", -1, {
                color = {255, 0, 0},
                multiline = true,
                args = {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ALERT: ~b~" .. GetPlayerName(player) .. ' ~y~has ~g~enabled~y~ city priorities being on hold!'}
            })
            SimplePrio_Success('SimplePrio  \n', '**→ ' .. GetPlayerName(source) .. ' used SimplePrio!\n ** **→ Successful: ** *True* \n** → Details:** *Countywide Priorities have been enabled!*\n **→ Priority System (City / County):** *City*\n **→ Hold Status:** *Enabled*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */priority ' .. Config.Priorities.City_Priority.Commands.mainCommand .. ' ' .. Config.Priorities.City_Priority.Commands.PrioOnHold .. '*.')
        end
...
local function SendChatMessage(color, message)
    TriggerClientEvent("chat:addMessage", -1, {color = color, multiline = true, args = message})
end

-- Function to toggle peacetime status
local function TogglePeacetime(player)
    local playerName = GetPlayerName(player)
    if peacetimeon then
        SendChatMessage({255, 0, 0}, {"~w~~w~[~b~SimplePrio~w~]  ", "Peacetime has been ~r~disabled~w~ by ~r~" .. playerName .. "~w~!"})
        SimplePrio_Success('SimplePrio  \n', '**→ ' .. playerName .. ' used SimplePrio!\n ** **→ Successful: ** *True* \n** → Details:** *Statewide Peacetime has been disabled!*\n **→ Peacetime Status:** *Disabled*\n \n**→ Time command was executed:** *' ..
            timestamp .. '* \n **→ Command Used: ** */' .. Config.Peacetime.Commands.Peacetime ..'*.')
    else
        SendChatMessage({255, 0, 0}, {"~w~~w~[~b~SimplePrio~w~]  ", "Peacetime has been ~g~enabled~w~ by ~r~" .. playerName .. "~w~!"})
...
RegisterCommand(Config.Peacetime.Commands.Peacetime, function(source, args, rawCommand)
    ...
    if not IsPlayerAceAllowed(player, Config.Permissions.PeacetimeAcePermission) then
        SendChatMessage({255, 0, 0}, {"~w~~w~[~b~SimplePrio~w~]  ", "~r~ERROR: ~y~You lack permissions needed to run this command!"})
